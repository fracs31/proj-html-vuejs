        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="informations">
                    ...
                    <div class="us">
                        <!-- Immagine -->
                        <img class="us__image" src="../assets/img/35.png" alt="Us">
                        <!-- Indirizzo -->
                        <h3 class="address">
                            9840 Shore St. Fond Du Lac, WI 54935
                        </h3>
                        <!-- Telefono -->
                        <p class="phone">
                            0 1223 456 789
                        ...
                        <form class="form">
                            ...
                            <textarea class="message" cols="30" rows="10" placeholder="Your Message"></textarea>
                            <!-- Bottone -->
                            <button class="btn">
                                Send message
                            </button>
